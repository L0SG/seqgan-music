    ...
    def __init__(
        ...
        with tf.variable_scope('discriminator'):
            ...
            with tf.name_scope("output"):
                ...
                # split the scores to real and fake scores
                self.scores_real, self.scores_fake = tf.split(self.scores, 2)
        ...
        grads_and_vars = d_optimizer.compute_gradients(self.wasserstein_loss, self.params, aggregation_method=2)
